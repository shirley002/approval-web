      ...
      <div class="fr">
        <div class="user-info-head" @click.stop="hoverHeaderDialog = true">
          ...
          <div class="hover-header-dialog " v-if="hoverHeaderDialog" @click="hideHeaderDialog">
            <ul>
              <li @click="messageWarn()" class="message-warn">
                <el-badge :value="unreadMsgCount" :max="99" class="item" v-if="unreadMsgCount">
                  消息提醒
                </el-badge>
        ...
        <div class="person-dialog" ref="personDialogItem">
          ...
          <div class="person-dialog-left">
            <div class="options-check-area">
              <div :class="messageWarnActive ? 'option-check-item message-option-area active':'option-check-item message-option-area'" @click="messageWarn"><span class="option-check-icon"></span>
                <el-badge :value="unreadMsgCount" :max="99" class="item" v-if="unreadMsgCount">
                  消息提醒
                </el-badge>
                <span v-else class="txt">消息提醒</span>
              </div>
              ...
              <!-- <div class="option-check-item exit-option-area"><span class="option-check-icon"></span>退出登录</div> -->
            </div>
          </div>
...
<script>
  ...
  import {logout, updatePwd, updateUserInfo, userMsgList, unreadMsgCount, readUserMsg} from "./api/header"
...
<style lang="scss" scoped>
 ...
 .option-check-item.active .option-check-icon{
  ...
  .person-dialog-right{
    height: 100%;float: left;width: 75%;background: #fff;line-height: 100%; position:relative;
    display: flex;
    justify-content: center;
    align-items: center;
  }
